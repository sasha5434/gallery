				<h2>Upload video (mp4, avi, mkv, wmv)</h2>
				...
				<div class="example-1">
					<div class="form-group">
						<label class="label"> <i class="material-icons"> attach_file </i> <span class="title js-value"> Add File </span>
							<input type="file" name="video"> </label>
					</div>
				</div>
				<br>
				...
				<div id="progress" class="progress" style="display: none;">
					...
					<div class="progress-value"> Uploaded </div>
				...
				<div id="progress2" class="progress" style="display: none;">
					...
					<div class="progress-value"> Processed </div>
					<div class="progress-bg">
						<div class="progress-bar"> </div>
					</div>
				</div>
				<div id="result2" style="display:none;">Video processing completed!<br/><br/>
					<ul>
					<li> <a href="/">Home page</a> </li>
					<li> <a href="/?do=upload">Upload image</a> </li>
					<li> <a href="/?do=upload&amp;method=video">Upload other video</a> </li>
				</ul>
				</div>
