<div style="text-align: center; font-size: 24px;"><a href="/?do=upload&method=video">Upload video</a></div>
<br />
<div class="upload">
    ...
    <div id="drop-files" ondragover="return false">
        <p>Drag image here</p>
        <form id="frm">
            <input type="file" id="uploadbtn" multiple /> </form>
    </div>
    <!-- Область предпросмотра -->
    <div id="uploaded-holder">
        <div id="dropped-files">
            <!-- Кнопки загрузить и удалить, а также количество файлов -->
            <div id="upload-button"> <span>0 Файлов</span> <a href="#" class="upload">Upload</a> <a href="#" class="delete">Delete</a>
    ...
    $(document).ready(function() {
        ...
        function loadInView(files) {
            ...
            $.each(files, function(index, file) {
                ...
                if ((dataArray.length + files.length) <= maxFiles) {
                    ...
                    alert('You cannot upload anymore ' + maxFiles + ' images!');
                    return;
                }
        ...
        function addImage(ind) {
            ...
            if (dataArray.length == 0) {
                ...
                $('#upload-button span').html("Selected 1 file");
            } else {
                $('#upload-button span').html(dataArray.length + " files selected");
            }
        ...
        $('#upload-button .upload').click(function() {
            ...
            $.each(dataArray, function(index, file) {
                ...
                $.post('/?do=upl&method=image', dataArray[index], function(data) {
